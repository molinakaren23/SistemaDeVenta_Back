...
namespace SistemaVenta.BLL.Servicios
{
    public class ProductoService : IProductoService
    {
        ...
        public ProductoService(IGenericRepository<Producto> productiRepositorio, IMapper mapper)
        {
            _productoRepositorio = productiRepositorio;
            _mapper = mapper;
        }
        ...
        public async Task<ProductoDTO> Crear(ProductoDTO modelo)
        {
            try
            {
                ...
                if (productoCreado.IdProducto == 0)
                    throw new TaskCanceledException("El producto no pudo ser creado");
        ...
        public async Task<bool> Eliminar(int id)
        {
            try{
                ...
                if (!respuesta)
                    throw new TaskCanceledException("Producto no se pudo eliminar");
